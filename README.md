...
| **OPTIONAL:** `--orientation` | `-o` | Poster orientation: portrait or landscape | portrait |
| **OPTIONAL:** `--width` | `-W` | Image width in inches (overrides orientation) | 12 |
| **OPTIONAL:** `--height` | `-H` | Image height in inches (overrides orientation) | 16 |
